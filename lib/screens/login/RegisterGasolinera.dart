...
class RegisterGasolinera extends StatefulWidget {
  @override
  _RegisterGasolineraState createState() => _RegisterGasolineraState();
}

class _RegisterGasolineraState extends State<RegisterGasolinera> {
                        ...
                        child: Stack(
                          children: [
                            CircleAvatar(
                              radius: radius,
                              backgroundImage:
                                  AssetImage("assets/images/gasolinera.jpg"),
                            ),
                            Positioned(
                              bottom: 0,
                              right: 4,
